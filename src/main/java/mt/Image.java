...
public class Image extends Signal {
    ...
    public void setBufferFromCenterArea(int outWidth, int outHeight, float[] inputBuffer, int inputWidth, int inputHeight) {
        // TODO: copy the center region of size outWidth x outHeight from inputBuffer
        // (which has dimensions inputWidth x inputHeight) into this image's buffer
    }
